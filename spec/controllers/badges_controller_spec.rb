...
RSpec.describe BadgesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested badge as @badge" do
      badge = Badge.create! valid_attributes
      get :show, params: {id: badge.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested badge as @badge" do
      badge = Badge.create! valid_attributes
      get :edit, params: {id: badge.to_param}, session: valid_session
      expect(assigns(:badge)).to eq(badge)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Badge" do
        expect {
          post :create, params: {badge: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved badge as @badge" do
        post :create, params: {badge: invalid_attributes}, session: valid_session
        expect(assigns(:badge)).to be_a_new(Badge)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested badge" do
        badge = Badge.create! valid_attributes
        put :update, params: {id: badge.to_param, badge: new_attributes}, session: valid_session
        badge.reload
      ...
      it "assigns the requested badge as @badge" do
        badge = Badge.create! valid_attributes
        put :update, params: {id: badge.to_param, badge: valid_attributes}, session: valid_session
        expect(assigns(:badge)).to eq(badge)
      end
    ...
    context "with invalid params" do
      it "assigns the badge as @badge" do
        badge = Badge.create! valid_attributes
        put :update, params: {id: badge.to_param, badge: invalid_attributes}, session: valid_session
        expect(assigns(:badge)).to eq(badge)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested badge" do
      badge = Badge.create! valid_attributes
      expect {
        delete :destroy, params: {id: badge.to_param}, session: valid_session
      }.to change(Badge, :count).by(-1)
    end
